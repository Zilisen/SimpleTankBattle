...
public static class NetManager
{
    ...
    // 接收缓冲区
    public static ByteArray readBuff;
    // 写入队列
    public static Queue<ByteArray> writeQueue;
    ...
    // 事件委托类型
    public delegate void EventListener(string args);
    // 事件监听列表
    ...
    // 触发事件
    public static void FireEvent(NetEvent netEvent, string args)
    {
        if (eventListeners.ContainsKey(netEvent))
        {
            eventListeners[netEvent].Invoke(args);
        }
    }
    ...
    public static void OnReceiveData()
    {
        ...
        MsgBase msgBase = MsgBase.Decode(protoName,
                                    readBuff.bytes, readBuff.readIdx, bodyCount);
